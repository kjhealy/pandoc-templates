...
opts_chunk$set(fig.path='figures/paper-', cache.path='cache/report-', dev=c("png","pdf"), fig.width=14, fig.height=7, fig.show='hold', fig.lp="fig:", cache=TRUE, par=TRUE, echo=FALSE, results="hide", message=FALSE, warning=FALSE)
...
```{r sample-plot, fig.lp="fig:", fig.cap="Tea and Biscuits are correlated but there may be identifiability issues."}
