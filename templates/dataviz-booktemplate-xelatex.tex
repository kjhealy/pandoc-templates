...
\setmainfont[Numbers=OldStyle]{Feijoa Medium}
\setsansfont[Numbers={OldStyle,Proportional}]{Bitter Bold}
\setmonofont[Numbers=OldStyle,Scale=MatchLowercase]{Fira Mono}
