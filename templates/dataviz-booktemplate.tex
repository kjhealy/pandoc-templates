...
$if(cover-note)$
\bigskip
\noindent {\sffamily\bfseries About the Cover} $cover-note$
\medskip
$endif$
...
$if(author-note)$
\bigskip
\noindent {\sffamily\bfseries About the Author} $author-note$
\medskip
$endif$
...
\bigskip
\normalsize 
\noindent {\sffamily\bfseries Colophon} $colophon-note$
\medskip
$endif$
